...
def load_settings():
    ...
    if USE_MONGO:
        try:
            ...
            if doc:
                ...
                doc["model_id"] = "Qwen/Qwen3-VL-235B-A22B-Instruct"
    ...
    local_data["model_id"] = "Qwen/Qwen3-VL-235B-A22B-Instruct"
    for k, v in DEFAULT_SETTINGS.items():
...
def query_gemma_4_multimodal(image_bytes, file_ext, api_token, system_prompt=None, required_keys=None):
    ...
    model_id = settings.get("model_id", "Qwen/Qwen3-VL-235B-A22B-Instruct")
...
def handle_settings():
    ...
    if request.method == 'POST':
        ...
        settings["model_id"] = data.get("model_id", settings.get("model_id", "Qwen/Qwen3-VL-235B-A22B-Instruct"))
